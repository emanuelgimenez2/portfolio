...
export default function Card({ title, description, image, link, repo, tech = [], index = 0 }) {
  return (
    <article className="portfolio-card" style={{ animationDelay: `${index * 0.12}s` }}>
      ...
      <div className="portfolio-card-content">
        ...
        {tech.length > 0 && (
          <div className="portfolio-card-tech">
            {tech.map((t, i) => (
              <span className="portfolio-card-tech-pill" key={i}>{t}</span>
            ))}
          </div>
        )}
      </div>
      ...
      <div className="portfolio-card-footer">
        {link && (
          ...
          >
            <svg className="portfolio-card-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
        ...
        {repo && (
          ...
          >
            <svg className="portfolio-card-icon" fill="currentColor" viewBox="0 0 24 24">
